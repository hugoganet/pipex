 ...
 *
 * This function is typically used to free the result
 * of a function like ft_split, where the result is 
 * a dynamically allocated array of dynamically allocated strings.
 *
